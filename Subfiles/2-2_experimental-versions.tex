...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\linewidth]{hcl_vapor_treat}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\linewidth]{ca_ebsd}
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{(a) Blue and red dots show left and right contact angle, respectively, of liquid gallium on Goss-texture Galfenol. (b) Calculated surface energy values of \hkl(110) Fe-Ga grains using Equation \ref{youngs-eqn-ga}.}
