...
Possible errors with this method will arise from non-atomically flat surfaces and pillars, imperfect Cassie-Baxter states caused by gravity or capillary forces drawing the probe liquid into the gaps between pillars, and oxide formation at the sample surface. 


I propose that these errors can be minimized given the isotropic nature of single-crystals, the immiscibility of water with \nalk[s], and minimizing gap width on the patterned surface. 
